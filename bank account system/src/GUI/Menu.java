...
public class Menu extends JFrame {
	...
	public Menu() {
		...
		JLabel lblBankingSystem = new JLabel("Bank Account System");
		...
		lblNewLabel.setIcon(new ImageIcon(Menu.class.getResource("/img/bank.jpg")));
		lblNewLabel.setBounds(200, 89, 900, 600);
